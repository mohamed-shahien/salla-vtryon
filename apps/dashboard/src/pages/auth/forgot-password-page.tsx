      ...
      <div className="w-full max-w-md space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
        ...
        <Card className="p-8 border-border/50 shadow-2xl rounded-3xl bg-card/50 backdrop-blur-xl relative overflow-hidden group">
          ...
          <form onSubmit={handleSubmit} className="space-y-6 relative">
            ...
            <Button type="submit" disabled={isLoading} className="w-full h-12 rounded-xl bg-primary text-sm font-bold text-white shadow-lg shadow-primary/20 hover:scale-[1.01] active:scale-[0.99] transition-all">
              {isLoading ? (
