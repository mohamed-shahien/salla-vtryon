...
export const BUTTON_PRESETS: ButtonPreset[] = [
  // 1. Core Solid - solid primary + subtle lift
  {
    id: 'core-solid',
    name: 'Core Solid',
    nameAr: 'الزر الأساسي الواضح',
    description: 'تصميم تقليدي بلون علامتك التجارية، يبرز بوضوح عند مرور الماوس عليه.',
    iconStyle: 'filled',
  ...
  // 2. Soft Glow - soft gradient + glow hover
  {
    id: 'soft-glow',
    name: 'Soft Glow',
    nameAr: 'نور ناعم متدرج',
    description: 'يتميز بألوان متداخلة وتوهج هادئ يعطي لمسة عصرية لمتجرك.',
    iconStyle: 'duotone',
  ...
  // 3. Glass Air - translucent glass + blur
  {
    id: 'glass-air',
    name: 'Glass Air',
    nameAr: 'الزجاجي الشفاف',
    description: 'تصميم أنيق مستوحى من شكل الزجاج، يندمج بجمال مع خلفيات الصور.',
    iconStyle: 'line',
  ...
  // 4. Outline Pulse - outline + pulse ring
  {
    id: 'outline-pulse',
    name: 'Outline Pulse',
    nameAr: 'الزر المفتوح النابض',
    description: 'إطار خارجي بسيط مع حركة نبضية لفت انتباه العميل للقيام بالتجربة.',
    iconStyle: 'line',
  ...
  // 5. Premium Gold - luxury gradient + shine sweep
  {
    id: 'premium-gold',
    name: 'Premium Gold',
    nameAr: 'اللمسة الملكية الذهبية',
    description: 'تصميم فاخر بألوان ملكية ولمعان ساطع، مناسب للمنتجات الراقية.',
    iconStyle: 'filled',
    backgroundRecipe: 'gradient',
    borderRecipe: 'medium',
    borderRadius: 'rounded',
  ...
  // 6. Mono Sharp - clean monochrome + crisp border
  {
    ...
    name: 'Mono Sharp',
    nameAr: 'الرسمي الحاد',
    description: 'تصميم جاد وبحدود بارزة، يعطي انطباعاً رسمياً وموثوقاً لمتجرك.',
    iconStyle: 'line',
    backgroundRecipe: 'outline',
    borderRecipe: 'thick',
  ...
  // 7. Rounded Soft - friendly rounded pill + soft shadow
  {
    id: 'rounded-soft',
    name: 'Rounded Soft',
    nameAr: 'الدائري الناعم',
    description: 'زر بشكل بيضاوي مريح للعين، يعبر عن السهولة والود.',
    iconStyle: 'duotone',
    backgroundRecipe: 'solid-primary',
    borderRecipe: 'none',
    borderRadius: 'pill',
  ...
  // 8. Floating Fab - floating action feel + depth hover
  {
    id: 'floating-fab',
    name: 'Floating Fab',
    nameAr: 'الزر الطائر التفاعلي',
    description: 'زر بارز يطفو فوق المحتوى، يسهل الوصول إليه في أي وقت.',
    iconStyle: 'filled',
    backgroundRecipe: 'solid-primary',
    borderRecipe: 'none',
    borderRadius: 'rounded',
  ...
  // 9. Neon Edge - dark surface + bright outline
  {
    id: 'neon-edge',
    name: 'Neon Edge',
    nameAr: 'نيون مشع (مودرن)',
    description: 'تصميم مستقبلي بحواف مضيئة، ملفت جداً للنظر في الصفحات المزدحمة.',
    iconStyle: 'duotone',
    backgroundRecipe: 'solid-primary',
    borderRecipe: 'thick',
    borderRadius: 'compact',
  ...
  // 10. Ghost Highlight - low-emphasis ghost + active fill
  {
    ...
    nameAr: 'الزر الشفاف الهادئ',
    description: 'تصميم لا يظهر إلا عند الاقتراب منه، يحافظ على نظافة وبساطة واجهة متجرك.',
    iconStyle: 'line',
  ...
  // 11. Split Icon - separated icon capsule + label block
  {
    id: 'split-icon',
    name: 'Split Icon',
    nameAr: 'أيقونة ونص منفصلان',
    description: 'يفصل الأيقونة في مكان خاص بها لتنظيم أفضل وشكل احترافي.',
    iconStyle: 'filled',
    backgroundRecipe: 'outline',
    borderRecipe: 'medium',
    borderRadius: 'balanced',
  ...
  // 12. Elevated Card CTA - mini card style with micro copy area
  {
    ...
    nameAr: 'البطاقة البارزة',
    description: 'يعامل الزر كأنه بطاقة صغيرة مرتفعة عن الصفحة لجذبانتباه العميل.',
    iconStyle: 'duotone',
    backgroundRecipe: 'solid-primary',
    borderRecipe: 'none',
    borderRadius: 'rounded',
  ...
  // 13. Badge Trigger - compact badge / chip style
  {
    id: 'badge-trigger',
    name: 'Badge Trigger',
    nameAr: 'شارة التنبييه المدمجة',
    description: 'تصميم صغير جداً يشبه شارات الإشعارات، مناسب للمساحات الضيقة.',
    iconStyle: 'filled',
    backgroundRecipe: 'solid-primary',
    borderRecipe: 'none',
    borderRadius: 'pill',
  ...
  // 14. Underline Motion - text-first CTA + animated underline
  {
    ...
    nameAr: 'نص مع خط متحرك',
    description: 'بسيط جداً، يظهر ككلمات فقط مع خط سفلي جذاب يتحرك عند التفاعل.',
    iconStyle: 'line',
    backgroundRecipe: 'ghost',
    borderRecipe: 'none',
    borderRadius: 'none',
  ...
  // 15. Shimmer Strip - shimmer pass on hover
  {
    id: 'shimmer-strip',
    name: 'Shimmer Strip',
    nameAr: 'الوميض الجذاب',
    description: 'خلفية متدرجة مع لمعة خاطفة تمر عبر الزر لتشجيع العميل على الضغط.',
    iconStyle: 'duotone',
    backgroundRecipe: 'gradient',
    borderRecipe: 'none',
    borderRadius: 'balanced',
  ...
  // 16. Gradient Aura - rich gradient with aura shadow
  {
    id: 'gradient-aura',
    name: 'Gradient Aura',
    nameAr: 'الهالة الملونة',
    description: 'يجمع بين التدرج اللوني وظل خارجي عميق يعطي انطباعاً متميزاً.',
    iconStyle: 'filled',
    backgroundRecipe: 'gradient',
    borderRecipe: 'none',
    borderRadius: 'rounded',
  ...
  // 17. Editorial Minimal - premium text-first editorial feel
  {
    ...
    nameAr: 'النمط الصحفي البسيط',
    description: 'تصميم راقٍ يعتمد على الخطوط الرفيعة والمساحات البيضاء، مناسب لبراندات الموضة العالمية.',
    iconStyle: 'line',
    backgroundRecipe: 'outline',
    borderRecipe: 'thin',
    borderRadius: 'none',
  ...
  // 18. Tech Panel - angular border + panel depth
  {
    id: 'tech-panel',
    name: 'Tech Panel',
    nameAr: 'لوحة التحكم التقنية',
    description: 'تصميم عصري بخطوط سميكة، يوحي بالقوة التكنولوجية والذكاء الاصطناعي.',
    iconStyle: 'line',
    backgroundRecipe: 'solid-primary',
    borderRecipe: 'thick',
    borderRadius: 'compact',
  ...
  // 19. Soft Outline Fill - outline idle, filled on hover
  {
    ...
    nameAr: 'الإطار الذي يمتلئ',
    description: 'يبدأ كإطار فقط، وعندما يمرر العميل الماوس عليه يمتلئ باللون بشكل انسيابي.',
    iconStyle: 'duotone',
    backgroundRecipe: 'outline',
    borderRecipe: 'medium',
    borderRadius: 'balanced',
  ...
  // 20. Mobile Sticky CTA - optimized fixed mobile pill
  {
    ...
    nameAr: 'الزر الثابت للجوال',
    description: 'مصمم خصيصاً ليظهر بشكل ثابت أسفل شاشة الجوال، مما يجعل التجربة سهلة جداً للمتسوقين.',
    iconStyle: 'filled',
    backgroundRecipe: 'solid-primary',
    borderRecipe: 'none',
    borderRadius: 'pill',
